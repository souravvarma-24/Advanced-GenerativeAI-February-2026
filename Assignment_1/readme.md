...
| Task | Title | Core Concept |
|------|-------|--------------|
| 1 | User Login Check | Conditional validation logic |
| 2 | Pass / Fail Analyzer | Iteration & counter-based analysis |
| 3 | Simple Data Cleaner | String preprocessing & normalization |
| 4 | Message Length Analyzer | Feature extraction using built-in functions |
| 5 | Error Message Detector | Pattern identification in log data |
